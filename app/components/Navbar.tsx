...
const Navbar : React.FC = () => {
  ...
  return (
    <nav className={`${visible ? "" : "-translate-y-full"} fixed bg-transparent z-10 backdrop-blur-sm w-full duration-300 ease-in-out flex justify-between items-center px-11 md:px-4 py-4 md:justify-evenly`}>
        <Link href="/" className='bg-slate-800 w-[100px] py-1 px-[7px] text-white text-base rounded font-bold'>Rdwn <span className='bg-white text-black rounded px-1'>.tsx</span></Link>
        ...
        <div className='hidden sosmed justify-center gap-4 md:flex'>
         <a href="https://www.instagram.com/hyde.0brien/" target='_blank' className='duration-300 hover:text-teal-500'>
        ...
        <a href="mailto:daengridwan02@gmail.com" target='_blank' className='duration-300 hover:text-teal-500'>
        ...
        <a href="#" target='_blank' className='duration-300 hover:text-teal-500'>
